...
train[['user_price_ctotal','user_price_btotal','user_price_crate','user_price_brate','user_id','item_price_level']].to_csv('newdata/1/user_price_feature1.csv',index=None)
...
train[['user_collected_ctotal','user_collected_crate','user_collected_brate','user_id','item_collected_level']].to_csv('newdata/1/user_collected_feature1.csv',index=None)
...
train[['user_pv_ctotal','user_pv_btotal','user_pv_crate','user_pv_brate','user_id','item_pv_level']].to_csv('newdata/1/user_pv_feature1.csv',index=None)
...
train[['occupation_star_age_price_total','occupation_star_age_price_buy_total','occupation_star_age_price_buy_rate','item_price_level','user_occupation_id','user_star_level','user_age_level']].to_csv('newdata/1/occupation_star_age_price_feature1.csv',index=None)
...
train[['star_price_rate','user_star_level','item_price_level']].to_csv('newdata/1/star_price_feature1.csv',index=None)

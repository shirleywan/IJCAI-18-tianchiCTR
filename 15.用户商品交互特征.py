...
user_commodity[['occupation_item_click_buy_rate','occupation_item_click_buy_total','occupation_item_click_total','user_occupation_id','item_id']].to_csv('newdata/1/occupation_item_feature1.csv',index=None)
...
user_commodity[['age_item_click_buy_rate','age_item_click_buy_total','age_item_click_total','user_age_level','item_id']].to_csv('newdata/1/age_item_feature1.csv',index=None)
...
user_commodity[['star_item_click_buy_rate','star_item_click_buy_total','star_item_click_total','user_star_level','item_id']].to_csv('newdata/1/star_item_feature1.csv',index=None)
...
user_commodity[['age_occupation_click_total','age_occupation_click_buy_total','age_occupation_click_buy_rate','item_id','user_age_level','user_occupation_id']].to_csv('newdata/1/age_occupation_item_feature1.csv',index=None)
...
user_commodity[['age_star_click_total','age_star_click_buy_total','age_star_click_buy_rate','item_id','user_age_level','user_star_level']].to_csv('newdata/1/age_star_item_feature1.csv',index=None)
...
user_commodity[['occupation_star_click_total','occupation_star_click_buy_total','occupation_star_click_buy_rate','item_id','user_occupation_id','user_star_level']].to_csv('newdata/1/occupation_star_item_feature1.csv',index=None)
...
user_commodity[['occupation_star_age_click_total','occupation_star_age_click_buy_total','occupation_star_age_click_buy_rate','item_id','user_occupation_id','user_star_level','user_age_level']].to_csv('newdata/1/occupation_star_age_item_feature1.csv',index=None)

# 该用户在一个小时内点击该商品多少次

user_commodity[[
                'user_item_click_buy_rate','user_item_click_buy_total','user_item_click_total','user_item_diff',
                'user_id','item_id']].to_csv('newdata/1/user_item_feature1.csv',index=None)
exit(0)

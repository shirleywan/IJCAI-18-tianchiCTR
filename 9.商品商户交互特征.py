...
item = pd.read_csv('newdata/1/item_feature1.csv')
shop = pd.read_csv('newdata/1/shop_feature1.csv')
...
commodity_shop[['item_shop_click_buy_rate','item_shop_click_buy_total','item_shop_click_total','item_shop_sale_rate','shop_item_sale_rate','shop_id','item_id']].to_csv('newdata/1/shop_item_feature1.csv',index=None)

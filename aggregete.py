...
u = pd.read_csv('newdata/1/user_item_feature1.csv')#user_item_click_total,user_item_click_buy_total
u.drop_duplicates()
s = pd.read_csv('newdata/1/shop_feature1.csv')#shop_click_total,shop_click_buy_total
s.drop_duplicates()
i = pd.read_csv('newdata/1/item_feature1.csv')#item_click,item_buy
i.drop_duplicates()
...
train[['u_s_i_click','u_s_i_buy','u_s_i_uclick_rate','user_id','shop_id','item_id']].to_csv('newdata/1/user_shop_item_feature1.csv',index=None)
exit(0)

...
s = pd.read_csv('newdata/1/shop_feature1.csv')
...
train[['shop_brand_click','shop_brand_buy','shop_brand_rate','shop_brand_crate','shop_id','item_brand_id']].to_csv('newdata/1/shop_brand_feature1.csv',index=None)

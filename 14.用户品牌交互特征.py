...
train[['user_brand_click','user_brand_buy','user_brand_rate','user_brand_crate','user_id','item_brand_id']].to_csv('newdata/1/user_brand_feature1.csv',index=None)
...
train[['occupation_brand_buy','occupation_brand_click','occupation_brand_rate','user_occupation_id','item_brand_id']].to_csv('newdata/1/occupation_brand_feature1.csv',index=None)
...
train[['star_brand_buy','star_brand_click','star_brand_rate','user_star_level','item_brand_id']].to_csv('newdata/1/star_brand_feature1.csv',index=None)
...
train[['occupation_star_age_brand_buy','occupation_star_age_brand_click','occupation_star_age_brand_rate','user_star_level','user_age_level','user_occupation_id','item_brand_id']].to_csv('newdata/1/occupation_star_age_brand_feature1.csv',index=None)
...
# 该职业购买率
train['occupation_brand_rate'] = train['occupation_brand_buy']/train['occupation_brand_click']
train[['occupation_brand_buy','occupation_brand_click','occupation_brand_rate','user_occupation_id','item_brand_id']].to_csv('data/occupation_brand_feature3.csv',index=None)
